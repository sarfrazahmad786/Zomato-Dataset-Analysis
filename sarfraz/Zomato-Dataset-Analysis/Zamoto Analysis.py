...
df_data = pd.read_csv(r'D:\sarfraz\Zomato-Dataset-Analysis\Zamoto raw data\Zomato.csv', encoding='unicode_escape')
print(df_data)


# Loading excel file of country code using pandas

df_country = pd.read_excel(r'D:\sarfraz\Zomato-Dataset-Analysis\Zomato raw data\Country-Code.xlsx')
print(df_country)
...
# count total transaction happen in all the world
print(df.Country.value_counts())


#downlaod data
#df.to_csv(r"D:\sarfraz\Zomato-Dataset-Analysis\Zamoto raw data\zomato.csv")
print(df.to_string)